...
/// messages received on DEBUG_CHANNEL from objects owned by others"; verified live on 1.1.315 that a
/// viewer did not, and a second avatar got the script-warning box for another owner's prim. The sim
...
public class DebugChannelOwnerOnlyTests : OpenSimTestCase
{
    ...
    private sealed class Rig
    {
        ...
        public ScenePresence Owner, Other;
